...
**效果 以及代码结构**
<img src="img/1.gif">   <img src="img/1.jpg" height="80%">   
...
Material--------------------------------Material(color: Colors.red,  child: Widget)
Column----------------------------------Column(children: <Widget>[ ]);
Row-------------------------------------Row(children: <Widget>[ ]);
Text------------------------------------Text(title: '', style: TextStyle(color: , ontSize: 20.0, fontWeight:FontWeight.bold ))
